...
const perks = [
  ...
  },
  {
    ...
    Icon: Leaf,
    description: 
      "We've pledged 1% of sales to the preservation of restoration of the natural environment."
  }
]
     ...
     <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
        ...
        <p className="mt-6 text-lg max-w-prose text-muted-foreground">
          Welcome to estoreNext. Every assets on our platform is verified by our team to ensure our highest quality standards.
        </p>
